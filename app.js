...
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
// Función para crear una capa vectorial desde un archivo KML
...
//------------------------------------------------------------------------------------------
// Función para crear el estilo de los municipios con nombres
function styleMunicipios(feature) {
    var nombre = feature.get('name');

    // Estilo del polígono (el contorno del municipio)
    ...
    // Estilo para el nombre (la etiqueta de texto)
    var textStyle = new ol.style.Text({
        ...
        stroke: new ol.style.Stroke({
            color: 'rgba(255, 255, 255, 0.8)', // Borde blanco para que resalte
            width: 3
        }),
        overflow: true,
    });
    
    // Asigna ambos estilos a la misma característica
    return [polygonStyle, new ol.style.Style({ text: textStyle })];
}

//------------------------------------------------------------------------------------------
// Creación de la capa de municipios y le aplica el estilo con nombres
...
m_layer_municipios.setStyle(styleMunicipios);

//------------------------------------------------------------------------------------------
// Controles y vista del mapa
...
//-------------------------------------------------------------------------------
// La configuración de la vista de tu mapa
...
  ]),
  target: "map",
  // Aquí solo incluimos la capa de municipios
  layers: [m_layer_municipios],
  view: m_view,
});
